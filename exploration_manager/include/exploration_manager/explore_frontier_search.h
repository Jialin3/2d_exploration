...
struct Frontier {
  ...
  geometry_msgs::Point nearest_free; // 新增：最近自由点
...
public:
  ...
  ExploreFrontierSearch(costmap_2d::Costmap2D *costmap, double potential_scale,
...
protected:
  ...
  geometry_msgs::Point findNearestFreePoint(const geometry_msgs::Point &point);
