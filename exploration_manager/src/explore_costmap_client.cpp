...
namespace explorer {
    ...
    ExploreCostmapClient::ExploreCostmapClient(ros::NodeHandle& nh, ros::NodeHandle& private_nh, const tf::TransformListener* tf)
    : tf_(tf)
    , nh_(nh)
    , nh_private_(private_nh)
    {
    ...
    void ExploreCostmapClient::updateFullMap(const nav_msgs::OccupancyGrid::ConstPtr& msg)
    {
    ...
    void ExploreCostmapClient::updatePartialMap(
    ...
    geometry_msgs::Pose ExploreCostmapClient::getRobotPose() const
    {
